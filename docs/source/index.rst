...
To get your feet wet,check out the :doc:`usage` section for further information about how to get started with the :ref:`CLI` and necessary :ref:`prerequisites` setup. To deep dive into the builiding blocks of the **Sover Protocol**, you can take a look at the :doc:`computepods` section.
