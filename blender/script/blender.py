...
async def main(
    ...
    async def worker(ctx: WorkContext, tasks):
        ...
        scene_path = str(script_dir / "payload/cubes.blend")
        ...
        async for task in tasks:
            ...
            output_file = f"{script_dir}/output/output_{frame}.png"
...
if __name__ == "__main__":
    ...
    script_dir = pathlib.Path(__file__).resolve().parent.parent
    parser.set_defaults(log_file=f"{script_dir}/logs/blender-yapapi-{now}.log")
